  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-zinc-100 md:h-[40rem] md:w-96 dark:bg-zinc-900"
      >
...
export const BlurImage = ({
  ...
  return (
    <img
      ...
      loading="lazy"
      decoding="async"
      alt={alt ? alt : "Imagem do trabalho"}
      {...rest}
    />
  );
};
