...
const targetFile = path.resolve(__dirname, '../app/configurar/page.tsx');
let data = fs.readFileSync(targetFile, 'utf8');

const targetStartText = '  return (\n    <div className="min-h-screen bg-zinc-50 dark:bg-black transition-colors">\n      <header className="border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black">';
const startIndex = data.indexOf(targetStartText);

if (startIndex === -1) {
    console.error("Start text not found!");
    process.exit(1);
}

// Find the last '}' which is the end of ConfigurarPage and the file.
const endIndex = data.lastIndexOf('}\n');

if (endIndex === -1) {
    console.error("End text not found!");
    process.exit(1);
}
...
const replacementText = `  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black transition-colors flex flex-col pb-24 lg:pb-0">
        ...
        <div className="grid lg:grid-cols-5 gap-8 xl:gap-12">
                  ...
                  <div className="space-y-8 bg-white dark:bg-zinc-950/50 p-6 sm:p-8 rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 shadow-sm">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full px-4 py-3 bg-zinc-50 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-xl text-base sm:text-sm text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-900/20 dark:focus:ring-white/20 focus:border-zinc-900 dark:focus:border-white transition-all shadow-sm" 
                      />
                ...
                <motion.div key="etapa2" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} transition={{ duration: 0.3, ease: 'easeOut' }}>
                  ...
                  <div className="space-y-6 bg-white dark:bg-zinc-950/50 p-6 sm:p-8 rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 shadow-sm">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input 
                            ...
                            className="w-full pl-11 pr-4 py-3 bg-zinc-50 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-xl text-base sm:text-sm text-zinc-900 dark:text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900/20 dark:focus:ring-white/20 focus:border-zinc-900 dark:focus:border-white transition-all shadow-sm" 
                          />
                        </div>
                    ...
                    <div className="pt-4 pb-2">
                      <label className="block text-sm font-semibold text-zinc-900 dark:text-zinc-200 mb-2">E-mail Profissional</label>
                      <div className="relative">
                    ...
                    <div className="grid grid-cols-2 gap-4 sm:gap-6 pt-4 border-t border-zinc-100 dark:border-zinc-800/50 mt-4">
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          placeholder="UF" 
                          maxLength={2} 
                          className="w-full px-4 py-3 bg-zinc-50 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-xl text-base sm:text-sm text-zinc-900 dark:text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900/20 dark:focus:ring-white/20 focus:border-zinc-900 dark:focus:border-white transition-all uppercase shadow-sm" 
                        />
                      </div>
                    </div>
                  </div>
          ...
          <div className="hidden lg:block lg:col-span-2">
             <div className="sticky top-24 pt-2">
              ...
              <div className="shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.4)] rounded-[2.5rem] border border-zinc-200/50 dark:border-zinc-800/50 overflow-hidden transform transition-all duration-300 hover:scale-[1.02] bg-white dark:bg-black">
      ...
      {/* Footer Fixo do Mobile / Footer normal no Desktop */}
      <div className="fixed bottom-0 left-0 right-0 p-3 sm:p-4 bg-white/95 dark:bg-black/95 backdrop-blur-lg border-t border-zinc-200 dark:border-zinc-800 z-40 lg:relative lg:bg-transparent lg:backdrop-blur-none lg:border-t-0 lg:p-0 lg:max-w-5xl lg:mx-auto lg:px-4 lg:-mt-4 lg:pb-12 shadow-[0_-10px_40px_rgba(0,0,0,0.08)] dark:shadow-[0_-10px_40px_rgba(0,0,0,0.5)] lg:shadow-none">
        <div className="flex items-center justify-between gap-3 sm:gap-4 w-full h-full max-w-5xl mx-auto">
          {etapaAtual > 1 ? (
            <button 
              type="button" 
              onClick={voltar} 
              className="flex-1 lg:flex-none flex items-center justify-center py-3.5 lg:py-3 lg:px-6 rounded-xl font-semibold bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-900 dark:text-white transition-colors"
            >
...
const newData = data.substring(0, startIndex) + replacementText;
fs.writeFileSync(targetFile, newData, 'utf8');
console.log('Successfully replaced the JSX return block!');
